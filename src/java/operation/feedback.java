...
public class feedback extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
      ...
      String desc=request.getParameter("feed");
        ...
        try {
            if(request.getParameter("feedback")!=null){
                         o.addfeedback(desc,name);
//            RequestDispatcher d=   request.getRequestDispatcher("index.jsp");
//            d.forward(request, response);
  PrintWriter out = response.getWriter() ;

       
out.println("<meta http-equiv='refresh' content='3;URL=feedback.jsp'>");
   out.println("<p style='color:red;'> FEEDBACK IS ADDED !</p>");
