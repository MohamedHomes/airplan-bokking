<%-- 
    Document   : tiketReservation
    Created on : May 1, 2019, 2:57:28 PM
    Author     : Home
--%>
...
<html>
   <head>
            ...
            <tr height="50px" align="center"><td><h3><a href="Home.jsp">Home</a></h3></td>
                ...
                <td><h3><a href="feedback.jsp">Feedback</a></h3></td></tr>
                    <tr height="500px" align="center"><td colspan="4">
                            <form action="reservation" method="post"><table>
	...
	<option value="VI">Virgin Islands, U.S.</option>
                                ...
                                <tr><td></td><td><button  style="width: 150px;" type="submit" name="reserv">Insert</button></td></tr>
                                       </form>  
            </table>
               <p>   <b> Click Here to <a href="showdate.jsp">Show all tiket  </a> that resetvation</b></p>

                <p>  <b>  Click Here to <a href="update.jsp">update</a> users Airline Reservation data</b></p>
